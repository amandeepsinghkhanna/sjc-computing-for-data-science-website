...
## Corpus Check
- 17 files · ~122,234 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 234 nodes · 368 edges · 17 communities (15 shown, 2 thin omitted)
...
### Community 0 - "app.js"
Cohesion: 0.14
Nodes (18): bindSearchControls(), buildCheckpoints(), buildGlossary(), buildQuiz(), buildScrollOutline(), closeNav(), escapeHtml(), highlightPython() (+10 more)
...
Cohesion: 0.06
Nodes (29): Agent workflow, changelog.md, Documentation, Graphify knowledge graph, YAGNI, Architecture, Boot order, Cross-file contracts (+21 more)
...
Cohesion: 0.29
Nodes (7): Accessibility, Design tokens (`style.css`), External assets, Frontend, JavaScript surface (`app.js`), Markup (`index.html`), SEO and crawl
...
Cohesion: 0.20
Nodes (9): 2026-09-07T16:16:00+05:30, 2026-09-07T16:27:00+05:30, 2026-09-07T17:13:00+05:30, 2026-09-07T18:15:00+05:30, 2026-09-07T18:25:00+05:30, 2026-09-07T18:50:00+05:30, 2026-09-08T09:30:00+05:30, 2026-09-08T10:15:00+05:30 (+1 more)
...
## Knowledge Gaps
- **83 isolated node(s):** `Before exploring`, `After source changes`, `When`, `How`, `Template` (+78 more)
...
- **Why does `Algorithms` connect `Algorithms` to `Features`?**
