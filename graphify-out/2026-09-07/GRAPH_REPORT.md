# Graph Report - computing-for-datascience  (2026-09-07)

## Corpus Check
- 17 files · ~116,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 214 nodes · 328 edges · 19 communities (16 shown, 3 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b48606b3`
...
1. `Visualizer` - 13 edges
2. `Data Structures and Algorithms` - 11 edges
3. `TreeSearchVisualizer` - 10 edges
4. `Features` - 10 edges
5. `Algorithms` - 9 edges
6. `DSA Learning Hub` - 9 edges
7. `setStatus()` - 8 edges
8. `StackVisualizer` - 8 edges
9. `QueueVisualizer` - 8 edges
10. `LinkedListVisualizer` - 8 edges
...
### Community 0 - "app.js"
Cohesion: 0.16
Nodes (15): bindSearchControls(), buildCheckpoints(), buildGlossary(), buildQuiz(), closeNav(), escapeHtml(), highlightPython(), manhattan() (+7 more)

### Community 1 - "LinkedListVisualizer"
Cohesion: 0.12
Nodes (3): dsEmpty(), LinkedListVisualizer, StackVisualizer
...
Cohesion: 0.09
Nodes (18): Agent workflow, changelog.md, Documentation, Graphify knowledge graph, YAGNI, Checkpoints, Data structures, Linked list (singly) (+10 more)
...
### Community 6 - "Deployment"
Cohesion: 0.33
Nodes (6): Crawl and sharing, Dependencies at runtime, Deployment, Hosting, Local, What not to deploy as “app config”

### Community 7 - "Features"
Cohesion: 0.20
Nodes (10): Algorithm and structure lessons, Author (`#author`), Cheat sheet (`#cheat-sheet`), Features, Glossary (`#glossary`), Knowledge check (`#quiz`), Navigation and chrome, Print (+2 more)

### Community 8 - "Architecture"
Cohesion: 0.29
Nodes (7): Architecture, Boot order, Cross-file contracts, Data flow, Graphify, Layout (three runtime files), Visualizer engine (`Visualizer`)

### Community 9 - "Overview"
Cohesion: 0.29
Nodes (6): Audience, Overview, Pedagogical loop, What students learn, What this is, What this is not
...
Cohesion: 0.33
Nodes (5): 2026-09-07T16:16:00+05:30, 2026-09-07T16:27:00+05:30, 2026-09-07T17:13:00+05:30, 2026-09-07T18:15:00+05:30, Changelog
...
### Community 16 - ".render"
Cohesion: 0.18
Nodes (13): bindPathControls(), cellKey(), generateMaze(), generateTree(), GridSearchVisualizer, mazeHasPath(), neighbors4(), pathSleep() (+5 more)

### Community 17 - "Algorithms"
Cohesion: 0.22
Nodes (9): A* Search, Algorithms, Binary Search, Breadth-First Search, Bubble Sort, Checkpoints, Linear Search, Quick Sort (+1 more)
...
## Knowledge Gaps
- **75 isolated node(s):** `Before exploring`, `After source changes`, `When`, `How`, `Template` (+70 more)
...
- **Should `LinkedListVisualizer` be split into smaller, more focused modules?**
